...
use App\Providers\Keycloak\Exception\EncryptionConfigurationException;
...
class Keycloak extends AbstractProvider
{
    ...
    {
        $options = [
    'authServerUrl'             => env("KEYCLOAK_HOST_URL"),
    ...
    public function getUserIntrospect($token) {
        $client = new \GuzzleHttp\Client();
$response = $client->post($this->getBaseUrlWithRealm().'/protocol/openid-connect/token/introspect', [
            'form_params' => [
        ...
        // Lakukan sesuatu dengan respons introspeksi, misalnya:
       if($body->active) {
